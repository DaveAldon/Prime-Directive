...
//  Prime Directive
//
//  Created by David Crawford on Sunday, May 21, 2017
//  Copyright (c) David Crawford. All rights reserved.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString* projectPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"PrimeDirective.codea"];
